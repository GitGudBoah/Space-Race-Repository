if enemy_manager2.game_over = false{
	if gagarin.x > 1800 && gagarin.x < 1900{
		...
		text = "Barely... If he dies, I won't be able to tell him he was full of shit. So he better live.";
	}

	if gagarin.x > 4000 && gagarin.x < 4100{
		speaker = spr_com_glaucus;
		text = "He's been pushing himself lately. I'm worried that he might have caught a sickness.";
	}

	if gagarin.x > 7800 && gagarin.x < 7900{
		speaker = spr_com_demeter;
		text = "He has been coughing more than usual... Well? Let's test his blood and see if he has anything!";
	}
	...
	if gagarin.x > 16000 && gagarin.x < 16100{
		speaker = spr_com_demeter;
		text = "I've never seen a virus like this.";
	}
